...
func (c *Commands) defaultCommands() []*CommandItem {
	...
	if c.hasSession {
		commands = append(commands,
			NewCommandItem(c.com.Styles, "share", "Share Session", "ctrl+y", ActionShare{}),
			NewCommandItem(c.com.Styles, "unshare", "Unshare Session", "ctrl+u", ActionUnshare{}),
		)
	}

	// Add file picker command when session is active
	if c.hasSession && c.windowWidth >= sidebarCompactModeBreakpoint {
		commands = append(commands, NewCommandItem(c.com.Styles, "add_file", "Add File", "ctrl+a", ActionOpenDialog{
	...
	commands = append(commands,
		NewCommandItem(c.com.Styles, "switch_theme", "Switch Theme", "", ActionOpenDialog{ThemePickerID}),
		NewCommandItem(c.com.Styles, "toggle_plan_mode", "Toggle Plan Mode", "", ActionTogglePlanMode{}),
