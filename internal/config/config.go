...
type Attribution struct {
	...
	GeneratedWith bool         `json:"generated_with,omitempty" jsonschema:"description=Add Generated with Ghost line to commit messages and issues and PRs,default=true"`
}
...
type Options struct {
	...
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data (relative to working directory),default=.ghost,example=.ghost"` // Relative to the cwd
	...
	InitializeAs              string       `json:"initialize_as,omitempty" jsonschema:"description=Name of the context file to create/update during project initialization,default=AGENTS.md,example=AGENTS.md,example=GHOST.md,example=CLAUDE.md,example=docs/LLMs.md"`
...
// Config holds the configuration for Ghost.
type Config struct {
