...
import (
	...
	"github.com/swadhinbiswas/ghost/internal/projects"
	"github.com/swadhinbiswas/ghost/internal/ui/common"
	ui "github.com/swadhinbiswas/ghost/internal/ui/model"
	"github.com/swadhinbiswas/ghost/internal/version"
)

func init() {
	rootCmd.PersistentFlags().StringP("cwd", "c", "", "Current working directory")
	rootCmd.PersistentFlags().StringP("data-dir", "D", "", "Custom Ghost data directory")
...
Ghost run "Guess my 5 favorite Pokémon"

# Run a non-interactively with pipes and redirection
cat README.md | Ghost run "make this more glamorous" > GLAMOROUS_README.md

# Run with debug logging in a specific directory
Ghost --debug --cwd /path/to/project

# Run in yolo mode (auto-accept all permissions; use with care)
Ghost --yolo

# Run with custom data directory
Ghost --data-dir /path/to/custom/.ghost

# Continue a previous session
Ghost --session {session-id}
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Ghost crashed. If metrics are enabled, we were notified about it. If you'd like to report it, please copy the stacktrace above and open an issue at https://github.com/swadhinbiswas/ghost/issues/new?template=bug.yml") //nolint:staticcheck
		}
		return nil
	},
}
...
func setupApp(cmd *cobra.Command) (*app.App, error) {
	...
	if err := createDotGhostDir(cfg.Options.DataDirectory); err != nil {
		return nil, err
	}
...
func shouldEnableMetrics(cfg *config.Config) bool {
	if v, _ := strconv.ParseBool(os.Getenv("GHOST_DISABLE_METRICS")); v {
		return false
	}
...
func createDotGhostDir(dir string) error {
