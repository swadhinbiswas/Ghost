...
Ghost update-providers

# Update Catwalk providers from a custom URL
Ghost update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
Ghost update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
Ghost update-providers embedded

# Update Hyper provider information
Ghost update-providers --source=hyper

# Update Hyper from a custom URL
Ghost update-providers --source=hyper https://hyper.example.com
`,
