...
func (q *Queries) GetHourDayHeatmap(ctx context.Context) ([]GetHourDayHeatmapRow, error) {
	...
	defer rows.Close()
	var items []GetHourDayHeatmapRow
	for rows.Next() {
...
type GetTotalStatsRow struct {
	...
	TotalCompletionTokens interface{}
	TotalCost             interface{}
	TotalMessages         interface{}
	AvgTokensPerSession   interface{}
	AvgMessagesPerSession interface{}
}
...
type GetUsageByDayRow struct {
	Day              interface{}
	PromptTokens     sql.NullFloat64
	CompletionTokens sql.NullFloat64
	Cost             sql.NullFloat64
	SessionCount     int64
}
...
func (q *Queries) GetUsageByDayOfWeek(ctx context.Context) ([]GetUsageByDayOfWeekRow, error) {
	...
	defer rows.Close()
	var items []GetUsageByDayOfWeekRow
	for rows.Next() {
